# Nicolas Ramirez, Santiago Fracassi, Bruno Leon y Victoria ---
...
# cupos, productoCamion = Array[0..7] of string; menorPatente, mayorPatente, productos = Array[0..3] of string; auxProductoCamion, auxPatente: string;
# estado = Array[0..7] of char; auxEstado: char;
# tara, pesoBruto, pesoNeto = Array[0..7] of integer; totalNeto, promedioNeto, menorPeso, mayorPeso, camion, contadorCamiones = Array[0..3] of integer; posicion, punteroCamion, camionesRecibidos, auxPeso, i: integer

# locales
# main() var opcion: integer;
# adminstraciones() var opcion: char;
# menuDeAdministraciones() var opcion: char;
# entregaCupos() var patente: string;
# cupoDuplicado var busqueda: boolean;
# largoPatente() var contador: integer;
# registrarTara() var producto: string;
# reportes() var opcion: string;
...
'''
Inicialización de los archivos lógicos y apertura o creacion de archivos fìsicos.
'''
afProductos = "./archivos/Productos.dat"
...
#Para saber cual es el tamaño del registro en el archivo, para calcular las búsquedas y posicionarse en los registros
def TamanoRegProductos():
    alProductos.seek(0,0)
    primerProducto = pickle.load(alProductos)
    tamRegProductos = alProductos.tell()
...
def menuDeProductos():
    ...
    while(opcion != 'V'):
        ...
        if(opcion == 'A'):
            ...
            pickle.dump(p, alProductos) # guarda el objeto en el archivo
            alProductos.flush()


    #      Funciona pero falta validar si el producto no esta cargado
